...
#CHSTS_CONCURRENCY_LEVELS=${CHSTS_CONCURRENCY_LEVELS:='1 4 8 16 32 64 128 256 512 768 1024 1536 2048 4096'}
CHSTS_CONCURRENCY_LEVELS=${CHSTS_CONCURRENCY_LEVELS:='16 32 64 128'}

CHSTS_VERBOSE=${CHSTS_VERBOSE:=0}
CHSTS_TEST_DURATION=${CHSTS_TEST_DURATION:=1}
